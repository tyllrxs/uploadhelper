...
class MyFrame(wx.Frame, wx.lib.mixins.listctrl.ColumnSorterMixin):
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.cmbZone, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_3.Add(self.cmbBoard, 1, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        sizer_8.Add(self.cmbPostZone, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_8.Add(self.cmbPostBoard, 1, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
