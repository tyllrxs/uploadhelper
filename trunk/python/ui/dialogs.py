...
class MySettingDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.txtMinFileSize = wx.SpinCtrl(self.notebook_pane2, -1, "", min=0, max=9999)
        self.label_3 = wx.StaticText(self.notebook_pane2, -1, "-")
        self.txtMaxFileSize = wx.SpinCtrl(self.notebook_pane2, -1, "", min=0, max=9999)
        ...
        self.txtFileNoLarger = wx.SpinCtrl(self.notebook_pane2, -1, "", min=0, max=9999)
