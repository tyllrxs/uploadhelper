...
class MyLoginDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.cmbHost = wx.Choice(self, -1, choices = BBS_HOSTS, size=(180, -1))
        self.label_2 = wx.StaticText(self, -1, _("User"), style=wx.ALIGN_CENTRE)
        self.txtUser = wx.TextCtrl(self, -1, "", size=(180, -1))
        ...
        self.txtPwd = wx.TextCtrl(self, -1, "", size=(180, -1), style=wx.TE_PASSWORD)
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.cmbHost, 1, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        grid_sizer_1.Add(self.txtUser, 1, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
	grid_sizer_1.Add(self.lnkRegister, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        grid_sizer_1.Add(self.txtPwd, 1, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        grid_sizer_1.Add(self.chkRememberPwd, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        
        object_1.Add(grid_sizer_1, 1, wx.LEFT|wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 10)
